...
#define kServiceAppUrlScheme    @"practiceforlogin.practiceforlogin"

#define kConsumerKey            @"2mnNrrBdvbkV81A2GoCC"
#define kConsumerSecret         @"4WXLaNCAOC"
#define kServiceAppName         @"PracticeForLogin"
